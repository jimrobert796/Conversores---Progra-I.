...
namespace Conversor_volumen
{
    public partial class Form1 : Form
    {
         ...
         * Centímetro cúbico (cm³) = 0.001 L
         * Galón estadounidense (gal US) = 3.78541 L
         * Galón imperial (gal UK) = 4.54609 L
         * Onza líquida (fl oz) = 0.0295735 L
         * Pinta (pt US) = 0.473176 L
         * Cuarto (qt) = 0.946353 L
